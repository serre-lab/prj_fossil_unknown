...
<body>
    <div class="container">
        ...
        <div class="image-name">Unidentified Fossil Name: <strong>CU_0747cu</strong></div>
...
<div class="concept-card">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 677</em>, relative rank:  10</div>
            </div>
        </div>
    </div>
</body>

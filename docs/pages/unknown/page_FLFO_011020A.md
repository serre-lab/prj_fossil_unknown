...
<body>
    <div class="container">
        ...
        <div class="image-name">Unidentified Fossil Name: <strong>FLFO_011020A</strong></div>
...
<div class="concept-card">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 194</em>, relative rank:  9</div>
            </div>
<div class="concept-card">
                <div class="concept-images">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 752</em>, relative rank:  10</div>
            </div>
        </div>
    </div>
</body>

...
<body>
    <div class="container">
        ...
        <div class="image-name">Unidentified Fossil Name: <strong>FLFO_008564A</strong></div>
...
<div class="concept-card">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 740</em>, relative rank:  10</div>
            </div>
        </div>
    </div>
</body>

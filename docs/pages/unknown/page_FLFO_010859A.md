...
<body>
    <div class="container">
        ...
        <div class="image-name">Unidentified Fossil Name: <strong>FLFO_010859A</strong></div>
...
<div class="concept-card">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 1353</em>, relative rank:  10</div>
            </div>
        </div>
    </div>
</body>

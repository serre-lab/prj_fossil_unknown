...
<body>
    <div class="container">
        ...
        <div class="image-name">Unidentified Fossil Name: <strong>CU_0487</strong></div>
...
<div class="concept-card">
                ...
                <div class="concept-caption"><em style="color:blue;">Concept: 473</em>, relative rank:  10</div>
            </div>
        </div>
    </div>
</body>

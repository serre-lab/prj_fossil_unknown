...
<body>
    <div class="container">
        ...
        <div class="image-name">Image Name: <strong>FLFO_009747B</strong></div>
        ...
        <div class="predictions">
            ...
            <p>
                <b>Sci. Name, Obj/Science</b>:  __ __ __ __ __Unidentified Nemestrinidae
            </p>
            <p>
                <b>Geo Unit</b>: Lower Shale Unit
            </p>
            <p>
                <b>Description</b>: unknown leaf on same slab, no venation visible - CVT (3/4/2017)
            </p>
        </div>

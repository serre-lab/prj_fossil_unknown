...
<body>
    <div class="container">
        ...
        <div class="image-name">Image Name: <strong>FLFO_003193B</strong></div>
        ...
        <div class="predictions">
            ...
            <p>
                <b>Description</b>: unknown fossil leaf, 'Unidentified leaf' from MacGinitie pl.50 fig.3; leaf from bulk
tf2
            </p>
        </div>
